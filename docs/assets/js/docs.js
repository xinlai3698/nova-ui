...
var ApiCssColor = __webpack_require__(/*! ../docs/documents/api-css-color.md */ "./examples/docs/documents/api-css-color.md");
...
document.addEventListener('click', function (e) {
  var target = e.target;
  var matched = getCurrentNode('.code-view__ctrl', target);
...
{
  var $copyInput = document.getElementById('copy-field');
  document.addEventListener('click', function (e) {
    var target = e.target;
    var matched = getCurrentNode('.js-copy', target);
