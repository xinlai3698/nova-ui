...
var VirtualScrollList = __webpack_require__(/*! ../docs/components/virtual-scroll-list.md */ "./examples/docs/components/virtual-scroll-list.md");

var Dropdown = __webpack_require__(/*! ../docs/components/dropdown.md */ "./examples/docs/components/dropdown.md");

var Progress = __webpack_require__(/*! ../docs/components/progress.md */ "./examples/docs/components/progress.md");

var Tooltip = __webpack_require__(/*! ../docs/components/tooltip.md */ "./examples/docs/components/tooltip.md"); // Vue
...
var DropdownVue = __webpack_require__(/*! ../docs/components/vue/dropdown.md */ "./examples/docs/components/vue/dropdown.md");

var ProgressVue = __webpack_require__(/*! ../docs/components/vue/progress.md */ "./examples/docs/components/vue/progress.md");
...
router.set('/').set('/icon', setPage({
  ...
  native: Pagination,
  vue: PaginationVue
}, 'Pagination', runScript)).set('/progress', setPage({
  native: Progress,
  vue: ProgressVue
}, 'Progress', runScript)).set('/virtual-scroll-list', setPage({
  ...
  native: Tag,
  vue: TagVue
}, 'Tag', runScript)).set('/dropdown', setPage({
  native: Dropdown,
  vue: DropdownVue
}, 'Dropdown', runScript)).set('/tooltip', setPage({
  native: Tooltip //vue: Tooltip

}, 'Tooltip', runScript)).init(); // events 
